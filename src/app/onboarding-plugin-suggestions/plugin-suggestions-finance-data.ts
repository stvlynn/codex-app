...
// Plugin suggestion data for finance and data science roles.
...
const financePluginSuggestions = [
  {
    mailProvider: "google",
    pluginName: "slack",
...
const marketingPluginSuggestions = [
  {
    mailProvider: "google",
    pluginName: "slack",
    titleMessage: connectMessagesTitle,
...
export { financePluginSuggestions, marketingPluginSuggestions };
