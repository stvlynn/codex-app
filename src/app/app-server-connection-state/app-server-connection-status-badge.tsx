...
import { t as Tooltip } from "../../shared/ui/ui/tooltip-b.tsx";
import { AlertIcon } from "../../shared/icons/alert-icon.tsx";
import { Spinner } from "../../shared/ui/ui/spinner-dh-bmwxtt.tsx";
import { useNavigate } from "../../shared/utils/chunk-lfpyn7-ly.tsx";
import { useAppServerConnectionState } from "../../shared/utils/use-app-server-connection-state.ts";
import { getAppServerConnectionStatusInfo } from "./app-server-connection-error.ts";
import type { AppServerConnectionStatusBadgeProps } from "../dialog-layout/types.ts";
const STATUS_ICONS = {
  connecting: <Spinner />,
  restarting: <Spinner />,
  connected: (
