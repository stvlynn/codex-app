...
var iconResolverValue56 = iconResolverHelper1(
  ...
  iconResolverValue57 = {
    minimal:
      '<svg data-icon-sprite aria-hidden="true" width="0" height="0">\n  <symbol id="file-tree-icon-chevron" viewBox="0 0 16 16">\n    <path d="M12.4697 5.46973C12.7626 5.17684 13.2374 5.17684 13.5303 5.46973C13.8232 5.76262 13.8232 6.23738 13.5303 6.53028L8.53028 11.5303C8.23738 11.8232 7.76262 11.8232 7.46973 11.5303L2.46973 6.53028C2.17684 6.23738 2.17684 5.76262 2.46973 5.46973C2.76262 5.17684 3.23738 5.17684 3.53028 5.46973L8 9.93946L12.4697 5.46973Z" fill="currentcolor"/>\n  </symbol>\n  <symbol id="file-tree-icon-dot" viewBox="0 0 6 6">\n    <circle cx="3" cy="3" r="3" />\n  </symbol>\n  <symbol id="file-tree-icon-file" viewBox="0 0 16 16">\n    <path fill="currentColor" d="M8 1v3a3 3 0 0 0 3 3h3v5.5a2.5 2.5 0 0 1-2.5 2.5h-7A2.5 2.5 0 0 1 2 12.5v-9A2.5 2.5 0 0 1 4.5 1z" class="bg" opacity=".5"/>\n    <path fill="currentColor" d="M9.5 1a.5.5 0 0 1 .354.146l4 4A.5.5 0 0 1 14 5.5V6h-3a2 2 0 0 1-2-2V1z" class="fg"/>\n  </symbol>\n  <symbol id="file-tree-icon-lock" viewBox="0 0 16 16">\n    <path fill="currentcolor" d="M4 5.336V4a4 4 0 1 1 8 0v1.336c1.586.54 2 1.843 2 4.664v1c0 4.118-.883 5-5 5H7c-4.117 0-5-.883-5-5v-1c0-2.821.414-4.124 2-4.664M5.5 4v1.054Q6.166 4.998 7 5h2q.834-.002 1.5.054V4a2.5 2.5 0 0 0-5 0m-2 6v1c0 .995.055 1.692.167 2.193.107.483.246.686.35.79s.307.243.79.35c.5.112 1.198.167 2.193.167h2c.995 0 1.692-.055 2.193-.166.483-.108.686-.247.79-.35.104-.105.243-.308.35-.791.112-.5.167-1.198.167-2.193v-1c0-.995-.055-1.692-.166-2.193-.108-.483-.247-.686-.35-.79-.105-.104-.308-.243-.791-.35C10.693 6.555 9.995 6.5 9 6.5H7c-.995 0-1.692.055-2.193.167-.483.107-.686.246-.79.35s-.243.307-.35.79C3.555 8.307 3.5 9.005 3.5 10" />\n  </symbol>\n  <symbol id="file-tree-icon-ellipsis" viewBox="0 0 16 16">\n    <path d="M5 8.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0M9.5 8.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0M14 8.5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0" />\n  </symbol>\n</svg>',
    standard: iconResolverValue56,
    complete: iconResolverHelper1(iconResolverValue56, iconResolverValue55),
  },
  iconResolverValue58 = {
    ".babelrc": "babel",
    ".babelrc.json": "babel",
  ...
  iconResolverValue62 = new Set(["complete"]);
export function iconResolverR(iconResolverParam14) {
  return iconResolverValue57[
    iconResolverParam14 === "none" ? "minimal" : iconResolverParam14
  ];
}
function iconResolverHelper2(iconResolverParam16) {
  return `file-tree-builtin-${iconResolverParam16}`;
}
export function iconResolverI(iconResolverParam15) {
  return (
    iconResolverParam15 !== "none" &&
    iconResolverValue62.has(iconResolverParam15)
  );
}
function iconResolverHelper3(
  iconResolverParam4,
  iconResolverParam5,
  iconResolverParam6,
) {
  if (iconResolverParam4 === "minimal" || iconResolverParam4 === "none") return;
  let iconResolverValue76 = iconResolverParam4 === "complete",
    iconResolverValue77 = iconResolverValue58[iconResolverParam5.toLowerCase()];
  if (
    iconResolverValue77 != null &&
    (iconResolverValue76 || iconResolverValue61.has(iconResolverValue77))
  )
    return iconResolverValue77;
  for (let iconResolverValue78 of iconResolverParam6) {
    if (iconResolverValue76) {
      let iconResolverValue89 = iconResolverValue60[iconResolverValue78];
      if (iconResolverValue89 != null) return iconResolverValue89;
    }
    let iconResolverValue81 = iconResolverValue59[iconResolverValue78];
    if (
      iconResolverValue81 != null &&
      (iconResolverValue76 || iconResolverValue61.has(iconResolverValue81))
    )
      return iconResolverValue81;
  }
  return "default";
}
function iconResolverHelper4(iconResolverParam8) {
  return (
    iconResolverParam8.spriteSheet != null ||
    iconResolverParam8.remap != null ||
    iconResolverParam8.byFileName != null ||
    iconResolverParam8.byFileExtension != null ||
    iconResolverParam8.byFileNameContains != null
  );
}
function iconResolverN(iconResolverParam7) {
  return iconResolverParam7 == null
    ? {
        set: "complete",
        colored: true,
      }
    : typeof iconResolverParam7 == "string"
      ? {
          set: iconResolverParam7,
          colored: true,
        }
      : {
          ...iconResolverParam7,
          set:
            iconResolverParam7.set ??
            (iconResolverHelper4(iconResolverParam7) ? "none" : "complete"),
          colored: iconResolverParam7.colored ?? true,
        };
}
var iconResolverValue63 = (iconResolverParam20) =>
    iconResolverParam20.trim().toLowerCase(),
  _e = (iconResolverParam19) =>
    iconResolverParam19.split("/").at(-1) ?? iconResolverParam19,
  iconResolverValue64 = (iconResolverParam9) => {
    let iconResolverValue79 = iconResolverParam9.toLowerCase().split("."),
      iconResolverValue80 = [];
    for (
      let iconResolverValue88 = 1;
      iconResolverValue88 < iconResolverValue79.length;
      iconResolverValue88 += 1
    )
      iconResolverValue80.push(
        iconResolverValue79.slice(iconResolverValue88).join("."),
      );
    return iconResolverValue80;
  };
function $(iconResolverParam12, iconResolverParam13) {
  return typeof iconResolverParam12 == "string"
    ? {
        name: iconResolverParam12,
        remappedFrom: iconResolverParam13,
      }
    : {
        ...iconResolverParam12,
        remappedFrom: iconResolverParam13,
...
export function iconResolverT(iconResolverParam1) {
  let iconResolverValue65 = iconResolverN(iconResolverParam1),
    iconResolverValue66 = iconResolverValue65.remap,
    iconResolverValue67 = new Map();
  for (let [iconResolverValue83, iconResolverValue84] of Object.entries(
    iconResolverValue65.byFileName ?? {},
  ))
    iconResolverValue67.set(
      iconResolverValue83.toLowerCase(),
      iconResolverValue84,
    );
  let iconResolverValue68 = new Map();
  for (let [iconResolverValue86, iconResolverValue87] of Object.entries(
    iconResolverValue65.byFileExtension ?? {},
  ))
    iconResolverValue68.set(
      iconResolverValue63(iconResolverValue86),
      iconResolverValue87,
    );
  let iconResolverValue69 = Object.entries(
    iconResolverValue65.byFileNameContains ?? {},
  ).map(([iconResolverParam17, iconResolverParam18]) => [
    iconResolverParam17.toLowerCase(),
    iconResolverParam18,
  ]);
  return {
    resolveIcon: (iconResolverParam2, iconResolverParam3) => {
      if (
        iconResolverParam2 === "file-tree-icon-file" &&
        iconResolverParam3 != null
      ) {
        let iconResolverValue71 = _e(iconResolverParam3),
          iconResolverValue72 = iconResolverValue71.toLowerCase(),
          iconResolverValue73 = iconResolverValue67.get(iconResolverValue72);
        if (iconResolverValue73 != null)
          return $(iconResolverValue73, iconResolverParam2);
        for (let [
          iconResolverValue90,
          iconResolverValue91,
        ] of iconResolverValue69)
          if (iconResolverValue72.includes(iconResolverValue90))
            return $(iconResolverValue91, iconResolverParam2);
        let iconResolverValue74 = iconResolverValue64(iconResolverValue71);
        for (let iconResolverValue82 of iconResolverValue74) {
          let iconResolverValue85 =
            iconResolverValue68.get(iconResolverValue82);
          if (iconResolverValue85 != null)
            return $(iconResolverValue85, iconResolverParam2);
        }
        let iconResolverValue75 = iconResolverHelper3(
          iconResolverValue65.set,
          iconResolverValue71,
          iconResolverValue74,
        );
        if (iconResolverValue75 != null && iconResolverValue65.set !== "none")
          return {
            name: iconResolverHelper2(iconResolverValue75),
            remappedFrom: iconResolverParam2,
            token: iconResolverValue75,
          };
      }
      let iconResolverValue70 = iconResolverValue66?.[iconResolverParam2];
      return iconResolverValue70 == null
        ? {
            name: iconResolverParam2,
          }
        : $(iconResolverValue70, iconResolverParam2);
    },
  };
}
