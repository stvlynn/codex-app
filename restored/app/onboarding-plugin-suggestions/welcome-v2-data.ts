...
// Welcome v2 suggestion data organized by user role.

import { r as defineMessage } from "../../boundaries/lib-b-w-t6-a3-q0";
const connectAppsRowMessage = defineMessage({
...
const welcomeV2SuggestionsByRole = {
  engineering: [
    {
...
export { connectAppsRowMessage, welcomeV2SuggestionsByRole };
