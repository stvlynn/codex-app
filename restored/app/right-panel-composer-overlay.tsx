...
import { rightPanelComposerOverlayVisible$ } from "../app-shell/app-shell-state";
import { appShellRefN } from "../app-shell/app-shell-ref";
import { r as appShellTabControllerR } from "../app-shell/app-shell-tab-controller-cvk-uvg-ym";
import { persistedSignalF, persistedSignalU } from "../utils/persisted-signal";
import {
  ...
  scrollReserveVar,
  HEIGHT_CSS_VAR,
} from "../utils/right-panel-composer-overlay-scroll-reserve";
import { contentWrapperClass } from "../threads/thread-layout";
