// Restored from ref/webview/assets/upgrade-plan-dialog-BClBnbFb.js
//
...
export declare const UpgradePlanDialog: any;
export declare const UpgradePlanDialogModal: any;
