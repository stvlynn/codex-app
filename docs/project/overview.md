...
| [`deobfuscate-javascript`](../../.agents/skills/deobfuscate-javascript/) | Reverse-engineers the bundled JS in `ref/webview/assets` into readable code | `./restored/` |
...
- Keep generated artifacts (`ref/`, `restored/`) reproducible from the installed app via skills.
