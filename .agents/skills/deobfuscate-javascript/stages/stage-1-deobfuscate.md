...
```bash
bun <skill-dir>/src/infrastructure/detect.ts <input.js|->
```
...
```bash
bun <skill-dir>/src/infrastructure/unpack.ts <input.js|-> [--out output.js] [--max-iterations 5] [--no-eval]
```
...
```bash
bun <skill-dir>/src/infrastructure/string-array.ts <input.js|-> [--out output.js]
```
...
```bash
bun <skill-dir>/src/infrastructure/decode-strings.ts <input.js|-> [--out output.js]
```
...
```bash
bun <skill-dir>/src/infrastructure/control-flow-report.ts <input.js|-> [--out report.json]
```
...
```bash
bun <skill-dir>/src/infrastructure/deobfuscate.ts <input.js|-> [--out output.js] [--report report.json] \
