...
import { applyRenames } from "../infrastructure/apply.ts";
import { extractSymbols, type SymbolEntry } from "../infrastructure/extract.ts";
import { formatPath } from "../infrastructure/format.ts";
import { polish } from "../infrastructure/polish.ts";
import { findRenames } from "../infrastructure/smart-rename.ts";
import { JS_GLOBALS } from "../domain/chunk-classification.ts";
...
const USAGE =
  "Usage: bun src/application/auto-restore-full.ts --target src " +
  "[--manifest .deobfuscate-javascript/_full/manifest.json] " +
  "[--ledger .deobfuscate-javascript/_full/ledger.json] " +
