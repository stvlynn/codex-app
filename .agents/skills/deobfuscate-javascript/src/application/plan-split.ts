...
import type { SplitPlan, SplitPlanFile, SplitPlanReExport } from "../infrastructure/split-bundle.ts";
...
const USAGE =
  "Usage: bun src/application/plan-split.ts <polished.tsx> [--out split-plan.json] " +
